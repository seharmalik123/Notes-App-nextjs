'use client'  // Enables client-side randering for this component:
...
function useLocalStorage<T>(key: string, initialize: T){
...
export default function NotesApp() {
    ...
    //State to manage ID of the note being edited:
   ...
   //JSX return rendering the Notes App UI:
   return(
    <div className="flex flex-col h-screen bg-green-400 text-foreground">
        ...
        <main className="flex-1 overflow-auto p-4">
            ...
            className="w-full rounded-md border border-input bg-background p-2 text-forground focus: outline-none focus: ring-1 focus: ring-primary"
            />
            ...
            {editingNoteId === null ? (
                <Button onClick={handleAddNote} className="mt-2 bg-green-800">
                    Add Note
                </Button>
            ) : (
